...
#define ukui_menu_monitor_file_get       menu_get_file_monitor
#define ukui_menu_monitor_directory_get  menu_get_directory_monitor

#define ukui_menu_monitor_ref    menu_monitor_ref
#define ukui_menu_monitor_unref  menu_monitor_unref

#define ukui_menu_monitor_notify_add     menu_monitor_add_notify
#define ukui_menu_monitor_notify_remove  menu_monitor_remove_notify
#define ukui_menu_monitor_notify_ref     menu_monitor_notify_ref /* private */
#define ukui_menu_monitor_notify_unref   menu_monitor_notify_unref /* private */
